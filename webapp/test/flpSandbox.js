		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Examples for guide",
									"targetURL": "#mrui5examples-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrui5examples-display": {
								"semanticObject": "mrui5examples",
								"action": "display",
								"description": "UI5 Examples for guide",
								"title": "UI5 Examples for guide",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mr.ui5examples",
									"url": sap.ui.require.toUrl("mr/ui5examples")
								}
							}
						}
					}
